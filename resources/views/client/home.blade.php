...
@section('content')
    ...
    ?>
       <section id="home-section" class="hero">
           <div class="home-slider owl-carousel">
               @foreach($tbl_slider as $slider)
               <div class="slider-item" style="background-image: url({{asset(\Illuminate\Support\Facades\Storage::url($slider->slider_image))}});">
    ...
    <section class="ftco-section">
        ...
        <div class="container">
            <div class="row">
                @foreach($tbl_products as $product)
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="{{asset(\Storage::url($product->product_image))}}" alt="No Image">
