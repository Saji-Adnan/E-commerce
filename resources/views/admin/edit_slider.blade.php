                        ...
                        {!! Form::open(['action'=>'SliderController@save_slider' , 'method'=>'POST' , 'class'=>'form-horizontal' , 'enctype'=>'multipart/form-data']) !!}
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <input id="cname" class="form-control" name="description1" minlength="2" value="{{$select_slider->description1}}" type="text" required>
                                    <input id="cname" class="form-control" name="id" minlength="2" value="{{$select_slider->id}}" type="hidden" required>
                                </div>
                                <div class="form-group">
                                    <label for="cname">Description Two</label>
                                    <input id="cname" class="form-control" name="description2" minlength="2" value="{{$select_slider->description1}}" type="text" required>
                                </div>
                                <div class="form-group">
